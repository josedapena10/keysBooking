...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function ensurePmsVerifyNudge(sectionRow, show) {
        ...
        if (!nudge) {
            ...
            nudge.style.cssText = 'position: absolute; top: 15px; right: 15px; font-size: 12px; color: #000000; white-space: nowrap; font-family: "TT Fors", sans-serif; background: #FFFDED; border: 1px solid #e2e2e2; border-radius: 9999px; padding: 3px 6px;';
