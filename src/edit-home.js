...
// Scroll to top on mobile when clicking edit sections or cancel buttons
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Get all edit section containers (toolbar elements)
    const editSections = [
        'edit_photos',
        'edit_basics',
        'edit_title',
    ...
    // Add click listeners to all edit sections
    editSections.forEach(sectionName => {
        const section = document.querySelector(`[data-element="${sectionName}"]`);
        if (section) {
            section.addEventListener('click', scrollToTopOnMobile);
        }
    });

    // Get all cancel buttons (exit buttons in toolbarEdit)
    const cancelButtons = [
        'editListing_cancelButton_deleteListing',
        ...
        'editListing_cancelButton_basics',
        'editListing_cancelButton_title',
        'editListing_cancelButton_description',
        'editListing_cancelButton_checkInAndOut',
        'editListing_cancelButton_dock',
        'editListing_cancelButton_amenities',
        'editListing_cancelButton_location',
        'editListing_cancelButton_host'
    ];

    // Add click listeners to all cancel buttons
